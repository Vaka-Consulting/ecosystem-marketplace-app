...
export type MarketplaceConfigQuery = { __typename?: 'Query', marketplace_config?: { __typename?: 'MarketplaceAppConfig', protocol_owner_address: string, script_address: string, fee_oracle_address: string, fee_oracle_asset: string, fee_percentage: number, token_asset: string } | null };
